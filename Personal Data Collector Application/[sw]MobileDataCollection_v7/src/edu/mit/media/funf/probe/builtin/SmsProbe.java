...
public class SmsProbe extends DatedContentProviderProbe implements SmsKeys {
	...
	protected Map<String, CursorCell<?>> getProjectionMap() {
		...
		projectionMap.put(Sms.ADDRESS, stringCell()); // TODO: figure out if we have to normalize this first (maybe phone number)
		...
		projectionMap.put(Sms.SUBJECT, stringCell());
		projectionMap.put(Sms.BODY, stringCell());
		projectionMap.put(Sms.PERSON, stringCell());
